...
class build_scripts_jac_sw(dbuild_scripts):
    def copy_scripts(self):
        # add "# jac_sw.sys.path <modpath>" lines to end of installed scripts;
        # the jac_sw module will parse these comments to update sys.path.
